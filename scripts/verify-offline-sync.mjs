...
const checks = [
  ...
  ['public/app-recovery.js', 'function recoveryDestination(now)', 'same-origin deployment recovery'],
  ['public/app-recovery.js', 'return returnUrl.toString()', 'same-origin recovery destination'],
  ['public/app-recovery.js', "FRESH_SHELL_PATH = '/__bajetbn_fresh_shell__'", 'non-precached fresh shell recovery path'],
  ['public/app-recovery.js', 'new XMLHttpRequest()', 'fresh shell network bypass'],
  ['public/app-recovery.js', "request.open(", 'blocking fresh shell request'],
  ['public/app-recovery.js', 'document.write(html)', 'fresh shell document replacement'],
  ['public/app-recovery.js', 'replaceWithFreshNetworkShell()', 'fresh shell recovery bootstrap'],
  ['public/_headers', '/__bajetbn_fresh_shell__*', 'fresh shell no-store header'],
  ['public/app-recovery.js', 'window.location.replace(', 'deployment recovery navigation'],
  ['public/recovery-handoff.html', '/recovery-handoff.js', 'minimal recovery handoff page'],
  ['public/recovery-handoff.js', "ALLOWED_ORIGINS", 'recovery return-origin allowlist'],
