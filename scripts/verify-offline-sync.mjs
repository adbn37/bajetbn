...
const checks = [
  ...
  ['public/app-recovery.js', "RECOVERY_HANDOFF_PATH = '/recovery-handoff.html'", 'cross-origin recovery handoff'],
  ...
  ['public/app-recovery.js', "'https://www.bajetbn.com'", 'production alternate recovery origin'],
