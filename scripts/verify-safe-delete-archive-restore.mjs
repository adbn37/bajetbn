...
const checks = [
  ...
  ['Space restore button', files.spaces.includes('Restore Space')],
  ...
  ['Account restore button', files.accounts.includes('Restore account')],
  ['Archived budgets section', files.budgets.includes('Archived budgets')],
  ['Closed goals section', files.goals.includes('Closed and archived goals')],
  ['Stopped bills section', files.bills.includes('Stopped bills and instalments')],
  ['Hidden categories section', files.transactions.includes('Hidden categories')],
