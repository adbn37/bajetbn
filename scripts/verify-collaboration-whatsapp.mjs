...
const checks = [
  ...
  ['src/features/collaboration/CollaborationPage.tsx', 'Tell group head on WhatsApp'],
  ['src/features/collaboration/CollaborationPage.tsx', 'Accept automatically'],
  ['src/features/collaboration/JoinSpacePage.tsx', 'Join this Space'],
