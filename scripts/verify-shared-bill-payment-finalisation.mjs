...
const checks = [
  ...
  ['src/features/collaboration/CollaborationPage.tsx', 'Paid from BajetBN Account'],
  ['src/features/collaboration/CollaborationPage.tsx', 'Paid outside BajetBN'],
  ['src/features/collaboration/CollaborationPage.tsx', 'Amount paid now (BND)'],
  ['src/features/collaboration/CollaborationPage.tsx', 'Confirm & finalise'],
  ['src/features/collaboration/CollaborationPage.tsx', 'Reverse payment'],
  ['src/features/transactions/TransactionsPage.tsx', 'reverseSharedBillPayment'],
  ['src/features/transactions/TransactionsPage.tsx', 'Shared payment claim'],
